...
# When running, the program will first ask the user to input their basic information such as weight and height.Then, it offers several options for the user to choose which service they would like to have.
...
def BMI_calculator()->float:
    ...
    # The function will directly take in the height and weight values the user have put in and calculate their BMI value. 
...
def check_in()->str:
    ...
    #The above code will give the user basic feedback of how they are doing with basic health practices. 

def affirmation()->str:
    # The affirmation function will randomly chooses one of the four available health affirmation and return it to the user as a motivation. The random module is used here.
